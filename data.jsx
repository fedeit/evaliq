...
const TEAM = [
  {
    id: 'maya', tier: 2, name: 'Maya Patel', role: 'Tier 2 Support', tenure: '2y',
  ...
  {
    id: 'jordan', tier: 1, name: 'Jordan Reyes', role: 'Tier 1 Support', tenure: '8mo',
  ...
  {
    id: 'aisha', tier: 2, name: 'Aisha Saunders', role: 'Tier 2 Support', tenure: '3y',
    status: 'healthy', statusLabel: 'On track',
  ...
  {
    id: 'derek', tier: 1, name: 'Derek Whitmore', role: 'Tier 1 Support', tenure: '1y',
  ...
  {
    id: 'priya', tier: 3, name: 'Priya Anand', role: 'Tier 3 / Escalation', tenure: '4y',
    status: 'healthy', statusLabel: 'On track',
  ...
  {
    id: 'tomas', tier: 1, name: 'Tomás Vargas', role: 'Tier 1 Support', tenure: '6mo',
    status: 'warn', statusLabel: 'Needs attention',
